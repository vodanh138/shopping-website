...
<body style="display: flex;
    ...
    <div style="flex: 1;">
        ...
        <main>
            ...
            $sql_count = "SELECT COUNT(*) as total FROM order_table WHERE uid = '$uid'";
            $result_count = mysqli_query($con, $sql_count);
            $row_count = mysqli_fetch_assoc($result_count);
            $total_items = $row_count['total'];

            $sql = "SELECT * FROM order_table JOIN product_table ON order_table.pid = product_table.pid JOIN user_table ON user_table.uid = product_table.uid WHERE order_table.uid = '$uid'AND pname LIKE '%$search%' LIMIT $items_per_page OFFSET $offset";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div style="display: flex;
                        ...
                        '<p>' . $row['pname'] . '</p><br>
                            ...
                            <p>Seller: ' . $row['ori_username'] . '</p><br>
