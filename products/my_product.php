...
<body style="display: flex;
    ...
    <div style="flex: 1;">
        ...
        <main>
            ...
            $sql_count = "SELECT COUNT(*) as total FROM product_table WHERE uid = '$uid' AND pname LIKE '%$search%'";
            $result_count = mysqli_query($con, $sql_count);
            $row_count = mysqli_fetch_assoc($result_count);
            $total_items = $row_count['total'];

            $sql = "SELECT * FROM product_table WHERE uid = '$uid'AND pname LIKE '%$search%' LIMIT $items_per_page OFFSET $offset";
